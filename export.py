...
@torch.no_grad()
def run(data=ROOT / 'data/ASL.yaml',  # 'dataset.yaml path'
        weights=ROOT / 'ASL_1000epochs_416_16.pt',  # weights path
        imgsz=(416, 416),  # image (height, width)
    ...
    if any(tf_exports):
        ...
        if int8 or edgetpu:  # TFLite --int8 bug https://github.com/ultralytics/yolov5/issues/5707
            check_requirements(('flatbuffers==22.9.24',))  # required before `import tensorflow`
...
def parse_opt():
    ...
    parser.add_argument('--data', type=str, default=ROOT / './data/ASL_5_448.yaml', help='dataset.yaml path')
    parser.add_argument('--weights', nargs='+', type=str, default=ROOT / 'ASL_7_448_16_nano.pt', help='model.pt path(s)')
